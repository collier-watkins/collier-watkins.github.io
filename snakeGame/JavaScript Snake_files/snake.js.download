    ...
    return function(config) {
        ...
        */
        me.go = function() {
            ...
            // clear the old board position (maybe -1,-1 when growing snake, in which case do not clear old pos)
            if (playingBoard.grid[newHead.row] && playingBoard.grid[newHead.row][newHead.col]) {
                playingBoard.grid[newHead.row][newHead.col] = 0;
            }
            ...
            newHead.col = oldHead.col + columnShift[currentDirection];
            newHead.row = oldHead.row + rowShift[currentDirection];
            newHead.xPos = oldHead.xPos + xPosShift[currentDirection];
            newHead.yPos = oldHead.yPos + yPosShift[currentDirection];
            ...
            switch (playingBoard.grid[newHead.row][newHead.col]) {
                case 0: // free
                    playingBoard.grid[newHead.row][newHead.col] = 1;
                    var dtime = (new Date()).getTime() - ptime;
                    setTimeout(function(){me.go();}, snakeSpeed - dtime);
                    break;
                case playingBoard.getGridFoodValue():
                    playingBoard.grid[newHead.row][newHead.col] = 1;
                    me.eatFood();
                    var dtime = (new Date()).getTime() - ptime;
                    setTimeout(function(){me.go();}, snakeSpeed - dtime);
        ...
        */
        me.eatFood = function() {
            var growthIncr = Math.max(5, Math.floor(playingBoard.numBoardBlocks / 75));
            ...
            me.snakeCover = (me.snakeLength * 100 / playingBoard.numBoardBlocks).toFixed(1);
        ...
        */
        me.reset = function() {
            ...
            while (curNode !== me.snakeHead) {
                ...
                curNode.row = -1;
                curNode.col = -1;
                curNode.elm.style.left = "-1000px";
                curNode.elm.style.top = "-1000px";
                curNode.elm.className = me.snakeHead.elm.className.replace(/\bsnake-snakebody-dead\b/,'')
                curNode.elm.className += " snake-snakebody-alive";
                blockPool.push(curNode);
                curNode = nextNode;
            }
    ...
    */
    ...
    return function(inputConfig) {
        ...
        var me = this,
            ...
            myKeyListener,
            // Board components
            elmContainer, elmPlayingField, elmAboutPanel, elmCoverPanel, elmLengthPanel, elmWelcome, elmTryAgain;
        ...
        function createBoardElements() {
            ...
            elmAboutPanel.innerHTML = "SNAKE v1.2";

            elmCoverPanel = document.createElement("div");
            elmCoverPanel.className = "snake-panel-component";
            elmCoverPanel.innerHTML = "Cover: 0.1%";
            ...
            elmContainer.appendChild(elmCoverPanel);
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "Snake<p></p>You died.<p></p>";
        ...
        */
        ...
        /**
        * Sets the current state of the playing board. There are 3 states:
        *   0 - Welcome or Try Again dialog is present.
        *   1 - User has pressed "Start Game" on the Welcome or Try Again dialog but has not pressed an arrow key to move the snake.
        *   2 - The game is in progress and the snake is moving.
        ...
        */
        me.setupPlayingField = function () {
            ...
            elmCoverPanel.style.top = pLabelTop;
            elmCoverPanel.style.left = cWidth - 240 + "px";
            ...
            me.numBoardBlocks = (numBoardCols - 2) * (numBoardRows - 2);
        ...
        */
        me.foodEaten = function() {
            elmCoverPanel.innerHTML = "Cover: " + mySnake.snakeCover + "%";
